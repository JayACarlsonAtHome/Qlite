...
// Qlite.v002 — module interface over the shared implementation body
// (Sqlite.body.hpp). Both build configurations export the SAME public API under
// `Qlite::v002` (matching the textual header); the ONLY difference is how the std
...
// namespace, diverging from the header's `Qlite::v002::` spelling.
...
export module Qlite.v002;

#ifdef QLITE_IMPORT_STD
import std;
#endif

export namespace Qlite::v002 {
