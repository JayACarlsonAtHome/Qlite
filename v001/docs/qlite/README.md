# Qlite::v001 — feature docs

The wrapper, documented by feature. The [component README](../../Qlite/README.md) is the
quick start and layout; these pages are the detail behind each capability.
...
depends on; see [Qlite/README.md](../../Qlite/README.md#the-four-features).
