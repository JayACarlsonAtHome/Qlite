# Connection, RAII, and the statement cache — v001
...
```cpp
Qlite::v001::Sqlite db("app.db");     // opens (or creates) the database
...
This is the safety story: scope exit cleans up, including on the exception path.
